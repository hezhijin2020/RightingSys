...
{
    public partial class JobFileCategoryForm : BaseForm
    {
        /// <summary>
        /// 明声明变量
        /// </summary>
        private Models.ys_JobFileCategory model = new Models.ys_JobFileCategory();
        private BLL.JobFilesManager manager = new BLL.JobFilesManager();
        private bool IsNewAdd = false;
        private List<Models.ys_JobFileCategory> Datalist = new List<Models.ys_JobFileCategory>();

        /// <summary>
        ///构造函数
        /// </summary>
        public JobFileCategoryForm()
        {
        ...
        public override void AddNew()
        {
            IsNewAdd = true;
            txtFullName.Text ="";
            model = new Models.ys_JobFileCategory();
        }
        ...
        private void sbtnSave_Click(object sender, EventArgs e)
        {
            ...
            model.JobFileCategoryName = txtFullName.Text.Trim();
        ...
        private void tl_Type_FocusedNodeChanged(object sender, DevExpress.XtraTreeList.FocusedNodeChangedEventArgs e)
        {
            if (e.Node != null)
            {
                ...
                txtFullName.Text = model.JobFileCategoryName;
            }
        }
    }
}
