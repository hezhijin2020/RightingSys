...
namespace RightingSys.DAL
{
  ...
  FROM [RightingSys].[dbo].[ys_JobFiles]";
        ...
        {
            string sqlText = @"
                  INSERT INTO [RightingSys].[dbo].[ys_JobFileCategory]
                ([Id]
                ,[JobFileCategoryName]
                ,[ParentId]
                ,[CreateTime]
        ...
        {
            string sqlText = @"
             UPDATE [RightingSys].[dbo].[ys_JobFileCategory]
                SET [JobFileCategoryName] = @JobFileCategoryName
                   ,[ParentId] = @ParentId
        ...
        public bool DeleteCategory(Guid CategoryId)
        {
            ...
            string sqlText = @"UPDATE [RightingSys].[dbo].[ys_JobFileCategory] SET[IsRemoved] = @IsRemoved WHERE  [Id] = @Id";
        ...
        /// </summary>
        /// <returns></returns>
        public IList<Models.ys_JobFileCategory> GetAllListCategory()
        {
            string sqlText = @"SELECT [Id]
                ,[JobFileCategoryName]
                ,[ParentId]
                ,[CreateTime]
                ,[IsRemoved]
            FROM [RightingSys].[dbo].[ys_JobFileCategory]";

            DataTable dt = Models.SqlHelper.ExecuteDataTable(sqlText);

            return Models.SqlHelper.DataTableToList<Models.ys_JobFileCategory>(dt).ToList();
